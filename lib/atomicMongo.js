if (Meteor.isClient) {
      ...
      mongo_displayDate = function(dataObj){
            
            var outputMonthNum = dataObj.getMonth()
            var outputMonthArray = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
            var outputMonthValue = outputMonthArray[outputMonthNum]
            var outputDateValue = dataObj.getDate()
            var outputYearValue = dataObj.getFullYear()
            var outputHoursValue = dataObj.getHours()
            var outputMinutesValue = dataObj.getMinutes()
            
            var outputString = outputMonthValue + " " + outputDateValue + ", " + outputYearValue 
            return outputString
