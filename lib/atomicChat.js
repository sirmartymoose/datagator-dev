    ...
    $(userArray).each(function(x,y){
      ...
      snippet_currentUserMessage = function(msg){
        ...
        snippet_listUser = function(usr){
            ...
            var snip = "<li class='list-group-item listedUser'><div class='row'><div class='col-md-8'><p>" + usr + "</p></div><div class='col-md-4'><div class='badge' id='" + userReplace + "'></div></div></div></li>"
            return snip
